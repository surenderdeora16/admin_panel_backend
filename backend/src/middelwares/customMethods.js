...
module.exports = (req, res, next) => {
  ...
  res.someThingWentWrong = function (
    error = { message: language.SOMETHING_WENT_WRONG }
  ) {
  ...
  res.successInsert = function (data = [], message = "") {
  ...
  res.successDelete = function (data = [], message = "") {
    return this.status(200).json({
      status: true,
